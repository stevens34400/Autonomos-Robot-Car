...
//Function to read in keyboard input
...
struct thread_parameter
{
  ...
  int control;  //Toggle variable
  int quit;     //quit vairable
};
...
int main( void )
{
  ...
  if (io != NULL)
  {
    ...
    {
      case 'r':
        thread18_parameter.control=1;
          
      case 'g':
        thread19_parameter.control=1;
      
      case 'b':
        thread22_parameter.control=1;
        
      case 'y':
        thread23_parameter.control=1;
