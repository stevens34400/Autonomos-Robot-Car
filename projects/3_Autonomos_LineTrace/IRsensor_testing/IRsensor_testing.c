...
int main( void )
{
  ...
  struct thread_parameter         thread24_parameter;
  ...
  if (io != NULL)
  {
    ...
    thread24_parameter.pin = 24;
    thread24_parameter.pwm = &(io->pwm);
    thread24_parameter.gpio = &(io->gpio);
    thread24_parameter.done = &done;
    thread24_parameter.option = &option;
    thread24_parameter.pin = 25;
    thread24_parameter.pwm = &(io->pwm);
    thread24_parameter.gpio = &(io->gpio);
    thread24_parameter.done = &done;
    thread24_parameter.option = &option;
